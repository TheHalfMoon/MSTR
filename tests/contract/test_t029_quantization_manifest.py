...
def test_recovered_t029_manifest_binds_all_eight_ready_profiles() -> None:
    ...
    assert manifest["source_execution_head"] == "406de41d132fa6d24d55814f3f6dd4fced5f12bd"
    assert manifest["recovery_execution_head"] == "f0f0210a43fb0c70839259d29f9b8a24d7ca3f55"
...
def test_ministral_recovery_profile_binds_exact_actions_artifact_and_hashes() -> None:
    ...
    assert ministral["model_revision"] == "6f9c4b12a95b139af68670a6713616b757923735"
    assert ministral["actions_run_id"] == 33263175072
    assert ministral["actions_artifact_id"] == 9729481097
    assert ministral["f16_sha256"] == "30b2f0f8cf5a0b0c5ac3599d3b3de777df74714d49375e43359bb4c1fddbc1de"
    assert ministral["f16_size_bytes"] == 6866212448
    assert ministral["quantization_arms"] == {
        "Q4_K_M": {
            "output_sha256": "31a399bb99a851698948b0d0db5178ac64d20c55048b71a87d3fc25d0b9f0291",
            "output_size_bytes": 2146489952,
            "duration_s": 111.9,
        },
        "Q4_K_S": {
            "output_sha256": "81575340aac45340dc947bcab07c1d25b5f02c10ad5fa32c69e45a48803ce4aa",
