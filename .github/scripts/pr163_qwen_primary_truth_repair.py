...
provenance["interpretation"] = (
    ...
    "33964325389 failed closed on that mismatch before merge. The reconciliation now uses "
    "only the byte-verified primary artifact value; no inferred or truncated digest is used."
)
