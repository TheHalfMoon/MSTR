...
def main() -> None:
    ...
    assert arm["output_sha256"] == HISTORICAL_Q4_K_S
    assert len(HISTORICAL_Q4_K_S) == 65
    assert all(character in "0123456789abcdef" for character in HISTORICAL_Q4_K_S)
    ...
    arm["historical_reported_output_sha256"] = HISTORICAL_Q4_K_S
    ...
    provenance = {
        ...
        "q4_k_s_historical_reported_output_sha256": HISTORICAL_Q4_K_S,
        "q4_k_s_historical_reported_output_sha256_length": 65,
        "q4_k_s_size_bytes": 1246308960,
        "defect": "PRIMARY_ARTIFACT_Q4_K_S_HASH_IS_65_HEX_AND_CANNOT_BE_A_SHA256_DIGEST",
        "interpretation": (
            "The primary GitHub Actions artifact itself contains the 65-hex value. "
    ...
    section = """## Qwen 3.5 2B Primary-Artifact Integrity Defect
